...
//プロトタイプ宣言
//－－－－－－－－－－－－－－－－－－－－－/
void boss_shot_bulletH000();//円形発射
void boss_shot_bulletH001();//サイレントセレナ
void boss_shot_bulletH002();//パーフェクトフリーズ
void boss_shot_bulletH003();//恋の迷路
void boss_shot_bulletH004();//ケロちゃん雨風にも負けず
void boss_shot_bulletH005();//★弾幕
void boss_shot_bulletH006();//周りから中央への発射
void boss_shot_bulletH007();//周りから直線発射
void boss_shot_bulletH008();//反魂蝶
void boss_shot_bulletH015();//円形発射とサイレントセレナ
void boss_shot_bulletH016();//中央に合わせて２つ迫ってくる
void boss_shot_bulletH017();//パーフェクトフリーズと周りから直線
void boss_shot_bulletH018();//反魂蝶と円形発射
void boss_shot_bulletH019();//中央に合わせて２つ迫ってくる 円形発射
    ...
    if(t<60 && t%5==0){//修正
        ...
        for(i=0;i<30;i++){
            if((k=search_boss_shot())!=-1){
                ...
                if ((i+1) % 2 == 0) boss_shot.bullet[k].col = 1;//弾の色
                boss_shot.bullet[k].x     = boss.x; //座標
                boss_shot.bullet[k].y     = boss.y;
                boss_shot.bullet[k].knd   = 15;      //弾の種類
